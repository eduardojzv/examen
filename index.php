			...
			<div class="modal fade" id="cargArchi" tabindex="-1" role="dialog" aria-labelledby="etiTitulo" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form method="post" enctype="multipart/form-data" action="grafica.php">
							<div class="modal-body">
								<fieldset>
                        			<div>
                            			<label>Archivo:</label>
                                		<input type="file" name="txtArchi[]" multiple />
										<!---->
										<label>Separador</label>
										<input type="text" name="separador">
										<!---->
										<br>
										<label>Tiene encabezados?</label>
										<input type="radio" name="info" id="info" value="si"> SI <br>
										<input type="radio" name="info" id="info" value="no"> NO
                            		</div>
                                </fieldset>
							</div>
